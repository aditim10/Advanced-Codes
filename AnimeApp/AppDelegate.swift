...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    /// Fully adaptive orientation: the app rotates freely on every device. iPad
    /// supports all four orientations (including upside-down); iPhone allows every
    /// orientation except upside-down, per platform convention. Trailer playback
    /// already rotated; now the whole browsing UI is responsive too.
    func application(_ application: UIApplication,
