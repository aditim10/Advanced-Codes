...
/// `GET characters/{id}/full` — a character's full profile: biography,
/// nicknames, favorites, and voice actors.
struct CharacterFullRequest: APIRequest {
    typealias Response = JikanSingleResponse<CharacterFull>

    let id: Int
    var path: String { Endpoint.characterFull(id: id) }
}
