...
enum Endpoint {
    ...
    /// Full profile for a single character, e.g. `characters/80/full`
    /// (bio, nicknames, favorites, voice actors).
    static func characterFull(id: Int) -> String { "characters/\(id)/full" }
}
